...
`Dado que o usuário submeteu o formulário de login com dados conrretos`
`Quando faço uma requisição POST`
`Então o status code deve ser iqual a 200`
...
`Dado que o usuário submeteu o formulário de login com um email em braco`
`Quando faço uma requisição POST para a rota /sessions`
`Então o status code deve ser igual a 400`
...
`Dado que o usuário submeteu o formulário de login com a senha em braco`
`Quando faço uma requisição POST para a rota /sessions`
`Então o status code deve ser igual a 400`
